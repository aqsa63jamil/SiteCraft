            ...
            <section class="about-section">
                <div class="container">
                    <div class="content row align-items-center">
                        <div class="col-md-6">
                            <img src="./Uploads/About us.png" alt="Our Team">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="effect row my-5">
                        ...
                        <div class="effect col-md-6 video-container">
                        ...
                        <div class="effect col-md-6" style="margin-top:10rem;">
                            <h3>Our Vision</h3>
                            <p>
                    ...
                    <div class="effect row testimonials-section">
                      ...
                      <!--cta start -->
            <section class="effect promo-section">
                <div class="container">
                    <div class="row">
