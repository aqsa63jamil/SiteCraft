            ...
            <section class="contact-section">
                <div class="container-fluid">
                    <div class="content row align-items-center">
                        <div class="col-md-6">
                            <img src="Uploads/contact.png" alt="Contact Us">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row my-5">
                        <div class="col-md-6 form-container">
                            <form action="contact-form-handler.php" method="POST" class="contact-form">
                                ...
                                <div class="mb-3 form-floating">
                                    <input class="form-control border-0 border-bottom no-outline" id="message" name="message" placeholder="Your Message" rows="4" required>
