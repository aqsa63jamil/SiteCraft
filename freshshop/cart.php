...
//             $updateQuery = "UPDATE cart SET quantity = ? WHERE session_id = ? AND product_id = ?";
...
//             $insertQuery = "INSERT INTO cart (session_id, product_id, product_name, product_price, product_image, quantity) VALUES (?, ?, ?, ?, ?, ?)";
//             $insertStmt = $conn->prepare($insertQuery);
//             if (!$insertStmt) {
//                 die("Prepare failed: " . $conn->error);
//             }
//             $quantity = 1;
//             $insertStmt->bind_param("sisssi", $sessionId, $productId, $product['name'], $product['price'], $product['image'], $quantity);
//             $insertStmt->execute();
//         }
//     }
...
//     $deleteQuery = "DELETE FROM cart WHERE session_id = ? AND product_id = ?";
...
//     $_SESSION['cart'] = [];
//     $cartQuery = "SELECT * FROM cart WHERE session_id = ?";
                                ...
                                <tr>
                                    ...
                                    <td class="quantity-box">
                                        <form action="cart.php" method="POST">
                                            <input type="number" size="4" value="<?php //echo $row['quantity']; ?>" min="1" step="1" class="c-input-text qty text" name="quantity">
                                            <input type="hidden" name="product_id" value="<?php //echo $row['product_id']; ?>">
                                            <input type="hidden" name="action" value="update">
                                            <button type="submit" class="btn" style="padding: 6px; font-size: 16px; background: #b0b435; color: #fff; margin:1rem; border: none; border-radius: 2px;">Update</button>
                                        </form>
                                    </td>
                                    <td class="total-pr">
                                       <p>$<?php //echo $total; ?></p> -->
