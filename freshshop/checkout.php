...
//     // Retrieve POST data
//     $paymentMethod = 'cod'; // Fixed to 'Cash on Delivery'
...
//     // Assuming you have a logged-in user with an ID
//     $userId = 1; // Replace with actual user ID

//     // Set payment status based on payment method
//     $paymentStatus = 'Pending'; // COD status is pending

//     // Use prepared statements for inserting data into orders table
...
//         header("Location: checkout.php?order_success=1&order_id=$orderId");
//         exit();
//     } else {
